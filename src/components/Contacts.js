...
function Contacts(){
    ...
    const templateID = "template_t3nw38g";
    const userID = "user_IIfKORBtWsWoQxZJUIiAK";
    ...
    function sendEmail(serviceID, templateID, variables, userID) {
        emailjs.send(serviceID, templateID, variables, userID)
            .then(() => {
                setSuccessMessage("Form sent successfully! I will be in touch.")
    ...
    return(
        <div id="contacts" className="contacts">
            ...
            <h1>Contact Me</h1>
            <p>Please fill out the form with a description of your enquiry</p>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-xs-12">
                        ...
                        <textarea type="text" className="form-control" placeholder="Message"
                                  name="description"
                                  ref={register({
                                      required: "Please leave a message description",
                                  })}/>
                            <div className="line"></div>
                        </div>
                        <span className="error-message">
